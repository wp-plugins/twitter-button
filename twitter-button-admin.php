...
<div class="tweetbutton_content">
	<div id="tab_content_1" class="single_content">
		...
		<form name="tb_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
			...
			<p>
				...
				<input type="radio" name="tb_tweet_text" value="2" <?php if (get_option('tb-tweet-text') == '2') echo 'checked="checked"'; ?>> 
				<input type="text" value="<?php echo get_option('tb-tweet-text-custom'); ?>" name="tb_tweet_text_custom" class="text-input medium-input" />
			</p>
	...
	<form name="tb_plugin_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
		...
		<tr>
			<td><input type="radio" name="tb_admin_lang" value="en" <?php if (get_option('tb-admin-lang') == "en") echo 'checked="yes"'; ?> /> <img src="<?php echo $plug_url.'/images/langs/flag-uk.png'; ?>" border="0" alt="en"/></td>
			<td><input type="radio" name="tb_admin_lang" value="bg" <?php if (get_option('tb-admin-lang') == "bg") echo 'checked="yes"'; ?> /> <img src="<?php echo $plug_url.'/images/langs/flag-bg.png'; ?>" border="0" alt="bg"/></td>
		</tr>
		</table>
...
Hope you enjoy it... </pre>
	...
	<div id="tab_content_4" class="single_content">
		...
		<ul>
			...
			<li><b><?php echo $tb_lang['version']; ?>:</b> 0.1<br /><br /></li>
